...
import com.example.eventinvention.Activity.profileActivity;
...
//        TextView logout= (TextView)view.findViewById(R.id.logout);
        ...
        bback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Pmyprofile.this, elaborated.class);
                startActivity(i);
...
//                statespinner2( jid);
                ...
                if (count == 0){
                    ...
                    String sst = String.valueOf(jSid);

                    statespinner2( sst);
                    Log.e("PassingState", String.valueOf(jSid));
...
////        });
    ...
    private void statespinner1() {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, URLs.URL_STATE, new Response.Listener<String>() {
            @Override
...
////////
                    ...
                    ArrayAdapter<String> sar =  new ArrayAdapter<String>(Pmyprofile.this, android.R.layout.simple_spinner_dropdown_item, CountryName);
//                    tState.setAdapter(new ArrayAdapter<String>(Pmyprofile.this, android.R.layout.simple_spinner_dropdown_item, CountryName));
                    tState.setAdapter(sar);
                   int ssid = jSid -1;
                    tState.setSelection(ssid);
...
//                            tCity.setAdapter(new ArrayAdapter<String>(Pmyprofile.this, android.R.layout.simple_spinner_dropdown_item, CountryName2));
//                            tCity.setSelection(2);

                            ArrayAdapter<String> car =  new ArrayAdapter<String>(Pmyprofile.this, android.R.layout.simple_spinner_dropdown_item, CountryName2);
                            tCity.setAdapter(car);
                            int spinnerPosition = car.getPosition(jcity);
                            tCity.setSelection(spinnerPosition);

                            Log.e("cityadapterpass",jcity);
                        }catch (JSONException e){e.printStackTrace();}
                    }
                },
                new Response.ErrorListener() {
    ...
    private void autodetails(final String id) {
                        ...
                        try{
                            ...
                            for(int i=0;i<jsonArray.length();i++){
                                ...
                                String   jid=jsonObject1.getString("id");
                                   ...
                                   jstate=jsonObject1.getString("state");
                                ...
                                String   jalternatenumber=jsonObject1.getString("alt_phone");
                                   ...
                                   jSid=jsonObject1.getInt("sid");
                                  jCid=jsonObject1.getInt("cid");
