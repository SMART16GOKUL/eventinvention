...
public class subgendralprofilepageActivity extends AppCompatActivity {
    ...
    TextView tname,tusertype,tcity,tcatname,tstate,tdesc,tvedio,tcname,tcpname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subgendralprofilepage);
        ...
        tcatname =  findViewById(R.id.tt5);
        trating =  findViewById(R.id.tt6);
        tvedio =  findViewById(R.id.tt7);
        tdesc =  findViewById(R.id.tt8);
...
//        Toast.makeText(vendorsprofilepageActivity.this, "  VALUE"+managerprofileis, Toast.LENGTH_SHORT).show();
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            for(int i=0;i<jsonArray.length();i++){
                                ...
                                String   jcat_names=jsonObject1.getString("cat_names");
                                        ...
                                        if (intrating != 0){
                                            ...
                                            if (!inrating1.equals("") && !comment.equals("")){
                                                ...
                                                if (inrating1.equals("")){
                                                    ...
                                                    Toast.makeText(subgendralprofilepageActivity.this, "Rating  Bar is Empty!", Toast.LENGTH_SHORT).show();
                                                }

                                                if (comment.equals("")){

                                                    Toast.makeText(subgendralprofilepageActivity.this, " Comment  Feild  is  empty!", Toast.LENGTH_SHORT).show();
                                            ...
                                            Toast.makeText(subgendralprofilepageActivity.this, " Submit   Faild Give  Rating  to Submit", Toast.LENGTH_SHORT).show();
...
//                                    String ve = "Click  this  to  View  Vedio  : "+jvideo;
    ...
    private void imggal1clickimage1(String jgalphoto1) {
        ...
        if (jgalphoto1.equals("0")){
            ...
            final Dialog dialog = new Dialog(subgendralprofilepageActivity.this);
...
//
//
                            Toast.makeText(subgendralprofilepageActivity.this, "  INSERTING  VALUES  SUCCESS", Toast.LENGTH_SHORT).show();
//
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.URL_VIEWCOMMENT,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Log.e("commentresponce",response);
...
//                            spinnnercity.setAdapter(new ArrayAdapter<String>(register.this, android.R.layout.simple_spinner_dropdown_item, CountryName2));
                            ...
                            mAdapter = new commentRecyclerAdapter(subgendralprofilepageActivity.this, personUtilsList);
